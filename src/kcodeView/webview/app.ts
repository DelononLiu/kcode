...
const _demoCards: Map<string, HTMLElement> = new Map();

function handleDemoCardUpdate(msg: any) {
...
function renderDemoCard(msg: any): HTMLElement {
    ...
    rerunBtn.addEventListener('click', () => {
        vscode.postMessage({ type: 'demoRerun', cardId: msg.cardId, taskId: msg.taskId, name: msg.name, command: msg.command, device: msg.device, envMeta: msg.envMeta });
    });
    ...
    stopBtn.addEventListener('click', () => {
        vscode.postMessage({ type: 'demoStop', cardId: msg.cardId, taskId: msg.taskId });
    });
