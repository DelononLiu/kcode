...
<head>
    ...
    <style nonce="${nonce}">
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        #header { display: flex; align-items: center; padding: 10px 16px; border-bottom: 1px solid var(--border); gap: 16px; flex-shrink: 0; background: var(--bg); }
        #header h1 { font-size: 16px; font-weight: 600; flex-shrink: 0; }
        #search-input { flex: 1; max-width: 280px; padding: 4px 8px; background: var(--input-bg); color: var(--input-fg); border: 1px solid var(--input-border); outline: none; font-size: 13px; border-radius: 2px; }
        ...
        #tab-bar { display: flex; border-bottom: 1px solid var(--border); padding: 0 16px; flex-shrink: 0; background: var(--bg); }
        ...
        th.col-workspace { width: 100px; }
        th.col-status { width: 70px; }
        th.col-phase { width: 60px; }
