...
/* === Round Summary Chip (subtle gray bar, square) === */
.round-summary{display:flex;align-items:center;padding:4px 0;font-size:12px;color:#777;cursor:pointer;user-select:none;transition:color .15s}
.round-summary:hover{color:#999}
.round-summary-chip{display:inline-flex;align-items:center;gap:6px;padding:4px 10px;background:#2a2a2d;border:1px solid #333;border-radius:2px;font-size:11.5px;font-weight:400;color:#888;transition:background .15s,border-color .15s}
.round-summary:hover .round-summary-chip{background:#2f2f32;border-color:#3a3a3d}
.round-summary.expanded .round-summary-chip{background:#2c2c30;border-color:#363639;color:#999}
