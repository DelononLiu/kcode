...
_目标：将存储从 Memento(key-value) 迁移到 SQLite，实现工具聚合原始数据存储；在此基础上沉淀跨任务可复用的知识 wiki，以独立 WebView 面板展示。_

| 任务 | 说明 | 状态 | 优先级 |
|------|------|------|--------|
| P14-01 | 存储层重构 — Memento → SQLite | ⬜ 未开始 | P0 |
| P14-02 | 工具聚合原始数据模型 | ⬜ 未开始 | P0 |
| P14-03 | 知识沉淀 — KnowledgeEntry 协议 + 存储 | ⬜ 未开始 | P1 |
| P14-04 | 知识 Wiki 独立面板 — KnowledgePanel | ⬜ 未开始 | P1 |
| P14-05 | 右栏知识索引区 | ⬜ 未开始 | P2 |
