...
| P39-02 | cp features/tasks/ → 换 IPC（任务运行记录） | ⬜ 未开始 | P0 |
| P39-03 | cp features/plan/ → 换 IPC（计划面板） | ⬜ 未开始 | P0 |
| P39-04 | PlanAdapter — Kanban 状态 ↔ TaskFlow 5 阶段映射 | 🛠️ 进行中 | P0 |
| P39-05 | 5 阶段管线可视化 — Goal/Plan/Execute/SelfVerify/Review 流程 UI | ⬜ 未开始 | P0 |
| P39-06 | StorageAdapter — desktop-cc-gui clientStorage → VS Code context.state | ⬜ 未开始 | P0 |
| P39-07 | 验证: 创建任务 → 走完 goal→plan→execute→verify→review 全流程 | ⬜ 未开始 | P0 |
